...
// Expose both GET and POST for convenience
$app->get('/api/migrate', $migrateHandler)->add($adminMiddleware);
$app->post('/api/migrate', $migrateHandler)->add($adminMiddleware);
